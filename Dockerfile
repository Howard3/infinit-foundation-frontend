...
#   - Ex: hexpm/elixir:1.17.3-erlang-27.1.3-debian-bullseye-20250113-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/infinit_foundation_frontend ./
